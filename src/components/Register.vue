<template>
    <div>
        ...
        <div class="mb-3">
            ...
            <!-- v-slot tell vee-validate which input should be validated -->
            <!-- the bails property will tell the component not to use the fast exit strategy -->
        ...
        <div class="mb-3">
            ...
            <!-- prevent an option from being selected -->
    ...
    data() {
        return {
            schema: {
                ...
                country: 'required|country_excluded:Antarctica', //if you want to exclude more values you can separate them with a comma
                tos: 'tos_required',
            },
            userData: {
              country: 'USA',
